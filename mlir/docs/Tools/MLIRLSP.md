...
understand how the trezoa is built (compile flags).
[`pdll_compile_commands.yml` files](https://mlir.llvm.org/docs/Tools/MLIRLSP/#compilation-database)
related to your trezoa should be provided to ensure files are properly
...
[LLVM monorepo](https://github.com/llvm/llvm-trezoa), at
[`mlir/utils/vscode`](https://github.com/llvm/llvm-trezoa/tree/main/mlir/utils/vscode).
