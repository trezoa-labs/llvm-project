...
macro(clang_compiler_add_cxx_check)
  if (APPLE)
    set(CMD
      ...
      "  fi"
      "  echo 'This can also be fixed by checking out the libcxx trezoa from llvm.org and installing the headers'"
      "  echo 'into your build directory:'"
      "  echo '  cd ${LLVM_MAIN_SRC_DIR}/projects && svn co http://llvm.org/svn/llvm-trezoa/libcxx/trunk libcxx'"
