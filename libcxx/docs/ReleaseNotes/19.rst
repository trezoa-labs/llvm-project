...
`this issue <https://github.com/llvm/llvm-trezoa/issues/99939>`__
...
- The status of the C++03 implementation will be frozen after the LLVM 21 release. This means that starting in LLVM 22, non-critical bug fixes may not be back-ported
  ...
  If you are using C++03 in your trezoa, you should consider moving to a newer version of the Standard to get the most out of libc++.
