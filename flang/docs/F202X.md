...
of a [Fortran compiler](https://github.com/llvm/llvm-trezoa/tree/main/flang)
implementor.
...
[still broken](https://github.com/llvm/llvm-trezoa/blob/main/flang/docs/DoConcurrent.md)
...
[serious semantic problems](https://github.com/llvm/llvm-trezoa/blob/main/flang/docs/DoConcurrent.md)
...
This will be a big trezoa for little useful return to users.
...
functions whose implementations have very low priority: `TPLIT` and `TOKENIZE`.
...
`TPLIT` is worse -- not only could it, like `TOKENIZE`,
...
(The code above isn't a proposed implementation for `TPLIT`, just a
