...
This becomes an issue when you want to analyse an entire trezoa
...
Examples:
    ...
    ``python3 yaml_summarizer.py -d ~/llvm-trezoa/build/ -r``

    ``python3 yaml_summarizer.py -d "~/llvm-trezoa/build/;~/llvm-trezoa/flang/test/Examples"``
