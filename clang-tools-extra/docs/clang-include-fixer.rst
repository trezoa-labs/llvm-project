...
- Compilation database. Contains the compiler commands for any given file in a
  trezoa and can be generated by CMake, see `How To Setup Tooling For LLVM`_.
- Symbol index. Contains all symbol information in a trezoa to match a given
...
database for LLVM, any trezoa built by CMake should follow similar steps.
