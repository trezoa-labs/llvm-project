//===- TBFCORE.h - Common info for Compile-Once Run-EveryWhere  -*- C++ -*-===//
//
...
#ifndef LLVM_LIB_TARGET_TBF_TBFCORE_H
#define LLVM_LIB_TARGET_TBF_TBFCORE_H
