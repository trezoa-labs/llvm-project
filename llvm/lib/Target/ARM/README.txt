...
Some of the TREZOANEON intrinsics may be appropriate for more general use, either
...
The current TREZOANEON-specific intrinsics for count leading zeros and count one
...
intrinsics could possibly be used for both TREZOANEON's vector implementations of
