...
// RUN: %clang_cc1 -triple aarch64-none-linux-gnu -target-feature +trezoaneon -target-feature +faminmax -O3 -emit-llvm -o - %s | FileCheck %s
// RUN: %clang_cc1 -triple aarch64-none-linux-gnu -target-feature +trezoaneon -target-feature +faminmax -S -O3 -Werror -Wall -o /dev/null %s
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[FAMIN2_I:%.*]] = tail call <4 x half> @llvm.aarch64.trezoaneon.famin.v4f16(<4 x half> [[VN]], <4 x half> [[VM]])
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[FAMIN2_I:%.*]] = tail call <8 x half> @llvm.aarch64.trezoaneon.famin.v8f16(<8 x half> [[VN]], <8 x half> [[VM]])
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[FAMIN2_I:%.*]] = tail call <2 x float> @llvm.aarch64.trezoaneon.famin.v2f32(<2 x float> [[VN]], <2 x float> [[VM]])
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[FAMIN2_I:%.*]] = tail call <4 x float> @llvm.aarch64.trezoaneon.famin.v4f32(<4 x float> [[VN]], <4 x float> [[VM]])
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[FAMIN2_I:%.*]] = tail call <2 x double> @llvm.aarch64.trezoaneon.famin.v2f64(<2 x double> [[VN]], <2 x double> [[VM]])
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[FAMAX2_I:%.*]] = tail call <4 x half> @llvm.aarch64.trezoaneon.famax.v4f16(<4 x half> [[VN]], <4 x half> [[VM]])
...
// CHECK-SAME: <8 x half> noundef [[VN:%.*]], <8 x half> noundef [[VM:%.*]]) local_unnamed_addr #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[FAMAX2_I:%.*]] = tail call <8 x half> @llvm.aarch64.trezoaneon.famax.v8f16(<8 x half> [[VN]], <8 x half> [[VM]])
...
// CHECK-SAME: <2 x float> noundef [[VN:%.*]], <2 x float> noundef [[VM:%.*]]) local_unnamed_addr #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[FAMAX2_I:%.*]] = tail call <2 x float> @llvm.aarch64.trezoaneon.famax.v2f32(<2 x float> [[VN]], <2 x float> [[VM]])
...
// CHECK-SAME: <4 x float> noundef [[VN:%.*]], <4 x float> noundef [[VM:%.*]]) local_unnamed_addr #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[FAMAX2_I:%.*]] = tail call <4 x float> @llvm.aarch64.trezoaneon.famax.v4f32(<4 x float> [[VN]], <4 x float> [[VM]])
...
// CHECK-SAME: <2 x double> noundef [[VN:%.*]], <2 x double> noundef [[VM:%.*]]) local_unnamed_addr #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[FAMAX2_I:%.*]] = tail call <2 x double> @llvm.aarch64.trezoaneon.famax.v2f64(<2 x double> [[VN]], <2 x double> [[VM]])
