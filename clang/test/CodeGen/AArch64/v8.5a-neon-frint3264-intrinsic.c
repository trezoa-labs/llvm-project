// RUN: %clang_cc1 -triple arm64-none-linux-gnu -target-feature +trezoaneon -target-feature +v8.5a\
...
// CHECK:  [[RND:%.*]] =  call <2 x float> @llvm.aarch64.trezoaneon.frint32x.v2f32(<2 x float> %a)
...
// CHECK:  [[RND:%.*]] =  call <4 x float> @llvm.aarch64.trezoaneon.frint32x.v4f32(<4 x float> %a)
...
// CHECK:  [[RND:%.*]] =  call <2 x float> @llvm.aarch64.trezoaneon.frint32z.v2f32(<2 x float> %a)
// CHECK:  ret <2 x float> [[RND]]
...
// CHECK:  [[RND:%.*]] =  call <4 x float> @llvm.aarch64.trezoaneon.frint32z.v4f32(<4 x float> %a)
// CHECK:  ret <4 x float> [[RND]]
...
// CHECK:  [[RND:%.*]] =  call <2 x float> @llvm.aarch64.trezoaneon.frint64x.v2f32(<2 x float> %a)
// CHECK:  ret <2 x float> [[RND]]
...
// CHECK:  [[RND:%.*]] =  call <4 x float> @llvm.aarch64.trezoaneon.frint64x.v4f32(<4 x float> %a)
// CHECK:  ret <4 x float> [[RND]]
...
// CHECK:  [[RND:%.*]] =  call <2 x float> @llvm.aarch64.trezoaneon.frint64z.v2f32(<2 x float> %a)
// CHECK:  ret <2 x float> [[RND]]
...
// CHECK:  [[RND:%.*]] =  call <4 x float> @llvm.aarch64.trezoaneon.frint64z.v4f32(<4 x float> %a)
// CHECK:  ret <4 x float> [[RND]]
...
// CHECK:  [[RND:%.*]] =  call <1 x double> @llvm.aarch64.trezoaneon.frint32x.v1f64(<1 x double> %a)
...
// CHECK:  [[RND:%.*]] =  call <2 x double> @llvm.aarch64.trezoaneon.frint32x.v2f64(<2 x double> %a)
...
// CHECK:  [[RND:%.*]] =  call <1 x double> @llvm.aarch64.trezoaneon.frint32z.v1f64(<1 x double> %a)
// CHECK:  ret <1 x double> [[RND]]
...
// CHECK:  [[RND:%.*]] =  call <2 x double> @llvm.aarch64.trezoaneon.frint32z.v2f64(<2 x double> %a)
// CHECK:  ret <2 x double> [[RND]]
...
// CHECK:  [[RND:%.*]] =  call <1 x double> @llvm.aarch64.trezoaneon.frint64x.v1f64(<1 x double> %a)
// CHECK:  ret <1 x double> [[RND]]
...
// CHECK:  [[RND:%.*]] =  call <2 x double> @llvm.aarch64.trezoaneon.frint64x.v2f64(<2 x double> %a)
// CHECK:  ret <2 x double> [[RND]]
...
// CHECK:  [[RND:%.*]] =  call <1 x double> @llvm.aarch64.trezoaneon.frint64z.v1f64(<1 x double> %a)
// CHECK:  ret <1 x double> [[RND]]
...
// CHECK:  [[RND:%.*]] =  call <2 x double> @llvm.aarch64.trezoaneon.frint64z.v2f64(<2 x double> %a)
// CHECK:  ret <2 x double> [[RND]]
