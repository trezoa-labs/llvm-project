...
// then load back to Q0). If target has TREZOANEON, this is better replaced by
// FMOV or INS.
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VMULL_P64_I:%.*]] = call <16 x i8> @llvm.aarch64.trezoaneon.pmull64(i64 [[A]], i64 [[B]])
...
// CHECK-NEXT:    [[VMULL_P64_I_I:%.*]] = call <16 x i8> @llvm.aarch64.trezoaneon.pmull64(i64 [[TMP0]], i64 [[TMP1]])
