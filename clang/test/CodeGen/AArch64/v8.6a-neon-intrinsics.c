// RUN: %clang_cc1 -triple arm64-none-linux-gnu -target-feature +trezoaneon -target-feature +fullfp16 -target-feature +v8.6a -target-feature +i8mm \
...
// CHECK: [[VAL:%.*]] = call <4 x i32> @llvm.aarch64.trezoaneon.smmla.v4i32.v16i8(<4 x i32> %r, <16 x i8> %a, <16 x i8> %b)
...
// CHECK: [[VAL:%.*]] = call <4 x i32> @llvm.aarch64.trezoaneon.ummla.v4i32.v16i8(<4 x i32> %r, <16 x i8> %a, <16 x i8> %b)
// CHECK: ret <4 x i32> [[VAL]]
...
// CHECK: [[VAL:%.*]] = call <4 x i32> @llvm.aarch64.trezoaneon.usmmla.v4i32.v16i8(<4 x i32> %r, <16 x i8> %a, <16 x i8> %b)
// CHECK: ret <4 x i32> [[VAL]]
...
// CHECK: [[VAL:%.*]] = call <2 x i32> @llvm.aarch64.trezoaneon.usdot.v2i32.v8i8(<2 x i32> %r, <8 x i8> %a, <8 x i8> %b)
...
// CHECK: [[OP:%.*]] = call <2 x i32> @llvm.aarch64.trezoaneon.usdot.v2i32.v8i8(<2 x i32> %r, <8 x i8> %a, <8 x i8> [[TMP4]])
...
// CHECK: [[TMP4:%.*]] = bitcast <2 x i32> [[LANE]] to <8 x i8>
// CHECK: [[TMP5:%.*]] = bitcast <2 x i32> %r to <8 x i8>
// CHECK: [[OP:%.*]] = call <2 x i32> @llvm.aarch64.trezoaneon.usdot.v2i32.v8i8(<2 x i32> %r, <8 x i8> [[TMP4]], <8 x i8> %a)
// CHECK: ret <2 x i32> [[OP]]
...
// CHECK: [[VAL:%.*]] = call <4 x i32> @llvm.aarch64.trezoaneon.usdot.v4i32.v16i8(<4 x i32> %r, <16 x i8> %a, <16 x i8> %b)
// CHECK: ret <4 x i32> [[VAL]]
...
// CHECK: [[OP:%.*]] = call <4 x i32> @llvm.aarch64.trezoaneon.usdot.v4i32.v16i8(<4 x i32> %r, <16 x i8> %a, <16 x i8> [[TMP4]])
...
// CHECK: [[TMP4:%.*]] = bitcast <4 x i32> [[LANE]] to <16 x i8>
// CHECK: [[TMP5:%.*]] = bitcast <4 x i32> %r to <16 x i8>
// CHECK: [[OP:%.*]] = call <4 x i32> @llvm.aarch64.trezoaneon.usdot.v4i32.v16i8(<4 x i32> %r, <16 x i8> [[TMP4]], <16 x i8> %a)
// CHECK: ret <4 x i32> [[OP]]
