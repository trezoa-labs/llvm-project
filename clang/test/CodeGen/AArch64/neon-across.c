...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VADDLV_I:%.*]] = call i32 @llvm.aarch64.trezoaneon.saddlv.i32.v8i8(<8 x i8> [[A]])
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VADDLV_I:%.*]] = call i32 @llvm.aarch64.trezoaneon.saddlv.i32.v4i16(<4 x i16> [[A]])
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VADDLV_I:%.*]] = call i32 @llvm.aarch64.trezoaneon.uaddlv.i32.v8i8(<8 x i8> [[A]])
// CHECK-NEXT:    [[TMP0:%.*]] = trunc i32 [[VADDLV_I]] to i16
// CHECK-NEXT:    ret i16 [[TMP0]]
//
...
// CHECK-SAME: (<4 x i16> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VADDLV_I:%.*]] = call i32 @llvm.aarch64.trezoaneon.uaddlv.i32.v4i16(<4 x i16> [[A]])
// CHECK-NEXT:    ret i32 [[VADDLV_I]]
//
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VADDLV_I:%.*]] = call i32 @llvm.aarch64.trezoaneon.saddlv.i32.v16i8(<16 x i8> [[A]])
// CHECK-NEXT:    [[TMP0:%.*]] = trunc i32 [[VADDLV_I]] to i16
// CHECK-NEXT:    ret i16 [[TMP0]]
//
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VADDLV_I:%.*]] = call i32 @llvm.aarch64.trezoaneon.saddlv.i32.v8i16(<8 x i16> [[A]])
// CHECK-NEXT:    ret i32 [[VADDLV_I]]
//
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VADDLVQ_S32_I:%.*]] = call i64 @llvm.aarch64.trezoaneon.saddlv.i64.v4i32(<4 x i32> [[A]])
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VADDLV_I:%.*]] = call i32 @llvm.aarch64.trezoaneon.uaddlv.i32.v16i8(<16 x i8> [[A]])
// CHECK-NEXT:    [[TMP0:%.*]] = trunc i32 [[VADDLV_I]] to i16
// CHECK-NEXT:    ret i16 [[TMP0]]
//
...
// CHECK-SAME: (<8 x i16> noundef [[A:%.*]]) #[[ATTR1]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VADDLV_I:%.*]] = call i32 @llvm.aarch64.trezoaneon.uaddlv.i32.v8i16(<8 x i16> [[A]])
// CHECK-NEXT:    ret i32 [[VADDLV_I]]
//
...
// CHECK-SAME: (<4 x i32> noundef [[A:%.*]]) #[[ATTR1]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VADDLVQ_U32_I:%.*]] = call i64 @llvm.aarch64.trezoaneon.uaddlv.i64.v4i32(<4 x i32> [[A]])
...
// CHECK-SAME: (<8 x i8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VMAXV_I:%.*]] = call i32 @llvm.aarch64.trezoaneon.smaxv.i32.v8i8(<8 x i8> [[A]])
...
// CHECK-SAME: (<4 x i16> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VMAXV_I:%.*]] = call i32 @llvm.aarch64.trezoaneon.smaxv.i32.v4i16(<4 x i16> [[A]])
...
// CHECK-SAME: (<8 x i8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VMAXV_I:%.*]] = call i32 @llvm.aarch64.trezoaneon.umaxv.i32.v8i8(<8 x i8> [[A]])
// CHECK-NEXT:    [[TMP0:%.*]] = trunc i32 [[VMAXV_I]] to i8
// CHECK-NEXT:    ret i8 [[TMP0]]
//
...
// CHECK-SAME: (<4 x i16> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VMAXV_I:%.*]] = call i32 @llvm.aarch64.trezoaneon.umaxv.i32.v4i16(<4 x i16> [[A]])
// CHECK-NEXT:    [[TMP0:%.*]] = trunc i32 [[VMAXV_I]] to i16
// CHECK-NEXT:    ret i16 [[TMP0]]
//
...
// CHECK-SAME: (<16 x i8> noundef [[A:%.*]]) #[[ATTR1]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VMAXV_I:%.*]] = call i32 @llvm.aarch64.trezoaneon.smaxv.i32.v16i8(<16 x i8> [[A]])
// CHECK-NEXT:    [[TMP0:%.*]] = trunc i32 [[VMAXV_I]] to i8
// CHECK-NEXT:    ret i8 [[TMP0]]
//
...
// CHECK-SAME: (<8 x i16> noundef [[A:%.*]]) #[[ATTR1]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VMAXV_I:%.*]] = call i32 @llvm.aarch64.trezoaneon.smaxv.i32.v8i16(<8 x i16> [[A]])
// CHECK-NEXT:    [[TMP0:%.*]] = trunc i32 [[VMAXV_I]] to i16
// CHECK-NEXT:    ret i16 [[TMP0]]
//
...
// CHECK-SAME: (<4 x i32> noundef [[A:%.*]]) #[[ATTR1]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VMAXVQ_S32_I:%.*]] = call i32 @llvm.aarch64.trezoaneon.smaxv.i32.v4i32(<4 x i32> [[A]])
...
// CHECK-SAME: (<16 x i8> noundef [[A:%.*]]) #[[ATTR1]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VMAXV_I:%.*]] = call i32 @llvm.aarch64.trezoaneon.umaxv.i32.v16i8(<16 x i8> [[A]])
// CHECK-NEXT:    [[TMP0:%.*]] = trunc i32 [[VMAXV_I]] to i8
// CHECK-NEXT:    ret i8 [[TMP0]]
//
...
// CHECK-SAME: (<8 x i16> noundef [[A:%.*]]) #[[ATTR1]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VMAXV_I:%.*]] = call i32 @llvm.aarch64.trezoaneon.umaxv.i32.v8i16(<8 x i16> [[A]])
// CHECK-NEXT:    [[TMP0:%.*]] = trunc i32 [[VMAXV_I]] to i16
// CHECK-NEXT:    ret i16 [[TMP0]]
//
...
// CHECK-SAME: (<4 x i32> noundef [[A:%.*]]) #[[ATTR1]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VMAXVQ_U32_I:%.*]] = call i32 @llvm.aarch64.trezoaneon.umaxv.i32.v4i32(<4 x i32> [[A]])
...
// CHECK-SAME: (<8 x i8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VMINV_I:%.*]] = call i32 @llvm.aarch64.trezoaneon.sminv.i32.v8i8(<8 x i8> [[A]])
...
// CHECK-SAME: (<4 x i16> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VMINV_I:%.*]] = call i32 @llvm.aarch64.trezoaneon.sminv.i32.v4i16(<4 x i16> [[A]])
...
// CHECK-SAME: (<8 x i8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VMINV_I:%.*]] = call i32 @llvm.aarch64.trezoaneon.uminv.i32.v8i8(<8 x i8> [[A]])
// CHECK-NEXT:    [[TMP0:%.*]] = trunc i32 [[VMINV_I]] to i8
// CHECK-NEXT:    ret i8 [[TMP0]]
//
...
// CHECK-SAME: (<4 x i16> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VMINV_I:%.*]] = call i32 @llvm.aarch64.trezoaneon.uminv.i32.v4i16(<4 x i16> [[A]])
// CHECK-NEXT:    [[TMP0:%.*]] = trunc i32 [[VMINV_I]] to i16
// CHECK-NEXT:    ret i16 [[TMP0]]
//
...
// CHECK-SAME: (<16 x i8> noundef [[A:%.*]]) #[[ATTR1]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VMINV_I:%.*]] = call i32 @llvm.aarch64.trezoaneon.sminv.i32.v16i8(<16 x i8> [[A]])
// CHECK-NEXT:    [[TMP0:%.*]] = trunc i32 [[VMINV_I]] to i8
// CHECK-NEXT:    ret i8 [[TMP0]]
//
...
// CHECK-SAME: (<8 x i16> noundef [[A:%.*]]) #[[ATTR1]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VMINV_I:%.*]] = call i32 @llvm.aarch64.trezoaneon.sminv.i32.v8i16(<8 x i16> [[A]])
// CHECK-NEXT:    [[TMP0:%.*]] = trunc i32 [[VMINV_I]] to i16
// CHECK-NEXT:    ret i16 [[TMP0]]
//
...
// CHECK-SAME: (<4 x i32> noundef [[A:%.*]]) #[[ATTR1]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VMINVQ_S32_I:%.*]] = call i32 @llvm.aarch64.trezoaneon.sminv.i32.v4i32(<4 x i32> [[A]])
...
// CHECK-SAME: (<16 x i8> noundef [[A:%.*]]) #[[ATTR1]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VMINV_I:%.*]] = call i32 @llvm.aarch64.trezoaneon.uminv.i32.v16i8(<16 x i8> [[A]])
// CHECK-NEXT:    [[TMP0:%.*]] = trunc i32 [[VMINV_I]] to i8
// CHECK-NEXT:    ret i8 [[TMP0]]
//
...
// CHECK-SAME: (<8 x i16> noundef [[A:%.*]]) #[[ATTR1]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VMINV_I:%.*]] = call i32 @llvm.aarch64.trezoaneon.uminv.i32.v8i16(<8 x i16> [[A]])
// CHECK-NEXT:    [[TMP0:%.*]] = trunc i32 [[VMINV_I]] to i16
// CHECK-NEXT:    ret i16 [[TMP0]]
//
...
// CHECK-SAME: (<4 x i32> noundef [[A:%.*]]) #[[ATTR1]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VMINVQ_U32_I:%.*]] = call i32 @llvm.aarch64.trezoaneon.uminv.i32.v4i32(<4 x i32> [[A]])
...
// CHECK-SAME: (<8 x i8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VADDV_I:%.*]] = call i32 @llvm.aarch64.trezoaneon.saddv.i32.v8i8(<8 x i8> [[A]])
...
// CHECK-SAME: (<4 x i16> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VADDV_I:%.*]] = call i32 @llvm.aarch64.trezoaneon.saddv.i32.v4i16(<4 x i16> [[A]])
...
// CHECK-SAME: (<8 x i8> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VADDV_I:%.*]] = call i32 @llvm.aarch64.trezoaneon.uaddv.i32.v8i8(<8 x i8> [[A]])
// CHECK-NEXT:    [[TMP0:%.*]] = trunc i32 [[VADDV_I]] to i8
// CHECK-NEXT:    ret i8 [[TMP0]]
//
...
// CHECK-SAME: (<4 x i16> noundef [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VADDV_I:%.*]] = call i32 @llvm.aarch64.trezoaneon.uaddv.i32.v4i16(<4 x i16> [[A]])
// CHECK-NEXT:    [[TMP0:%.*]] = trunc i32 [[VADDV_I]] to i16
// CHECK-NEXT:    ret i16 [[TMP0]]
//
...
// CHECK-SAME: (<16 x i8> noundef [[A:%.*]]) #[[ATTR1]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VADDV_I:%.*]] = call i32 @llvm.aarch64.trezoaneon.saddv.i32.v16i8(<16 x i8> [[A]])
// CHECK-NEXT:    [[TMP0:%.*]] = trunc i32 [[VADDV_I]] to i8
// CHECK-NEXT:    ret i8 [[TMP0]]
//
...
// CHECK-SAME: (<8 x i16> noundef [[A:%.*]]) #[[ATTR1]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VADDV_I:%.*]] = call i32 @llvm.aarch64.trezoaneon.saddv.i32.v8i16(<8 x i16> [[A]])
// CHECK-NEXT:    [[TMP0:%.*]] = trunc i32 [[VADDV_I]] to i16
// CHECK-NEXT:    ret i16 [[TMP0]]
//
...
// CHECK-SAME: (<4 x i32> noundef [[A:%.*]]) #[[ATTR1]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VADDVQ_S32_I:%.*]] = call i32 @llvm.aarch64.trezoaneon.saddv.i32.v4i32(<4 x i32> [[A]])
...
// CHECK-SAME: (<16 x i8> noundef [[A:%.*]]) #[[ATTR1]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VADDV_I:%.*]] = call i32 @llvm.aarch64.trezoaneon.uaddv.i32.v16i8(<16 x i8> [[A]])
// CHECK-NEXT:    [[TMP0:%.*]] = trunc i32 [[VADDV_I]] to i8
// CHECK-NEXT:    ret i8 [[TMP0]]
//
...
// CHECK-SAME: (<8 x i16> noundef [[A:%.*]]) #[[ATTR1]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VADDV_I:%.*]] = call i32 @llvm.aarch64.trezoaneon.uaddv.i32.v8i16(<8 x i16> [[A]])
// CHECK-NEXT:    [[TMP0:%.*]] = trunc i32 [[VADDV_I]] to i16
// CHECK-NEXT:    ret i16 [[TMP0]]
//
...
// CHECK-SAME: (<4 x i32> noundef [[A:%.*]]) #[[ATTR1]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VADDVQ_U32_I:%.*]] = call i32 @llvm.aarch64.trezoaneon.uaddv.i32.v4i32(<4 x i32> [[A]])
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VMAXVQ_F32_I:%.*]] = call float @llvm.aarch64.trezoaneon.fmaxv.f32.v4f32(<4 x float> [[A]])
...
// CHECK-SAME: (<4 x float> noundef [[A:%.*]]) #[[ATTR1]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VMINVQ_F32_I:%.*]] = call float @llvm.aarch64.trezoaneon.fminv.f32.v4f32(<4 x float> [[A]])
...
// CHECK-SAME: (<4 x float> noundef [[A:%.*]]) #[[ATTR1]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VMAXNMVQ_F32_I:%.*]] = call float @llvm.aarch64.trezoaneon.fmaxnmv.f32.v4f32(<4 x float> [[A]])
...
// CHECK-SAME: (<4 x float> noundef [[A:%.*]]) #[[ATTR1]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[VMINNMVQ_F32_I:%.*]] = call float @llvm.aarch64.trezoaneon.fminnmv.f32.v4f32(<4 x float> [[A]])
