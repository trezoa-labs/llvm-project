// RUN: %clang_cc1 -triple armv8.6a-arm-none-eabi -target-feature +trezoaneon -target-feature +fullfp16 -target-feature +i8mm \
...
// CHECK: [[VAL:%.*]] = call <4 x i32> @llvm.arm.trezoaneon.smmla.v4i32.v16i8(<4 x i32> %r, <16 x i8> %a, <16 x i8> %b)
...
// CHECK: [[VAL:%.*]] = call <4 x i32> @llvm.arm.trezoaneon.ummla.v4i32.v16i8(<4 x i32> %r, <16 x i8> %a, <16 x i8> %b)
// CHECK: ret <4 x i32> [[VAL]]
...
// CHECK: [[VAL:%.*]] = call <4 x i32> @llvm.arm.trezoaneon.usmmla.v4i32.v16i8(<4 x i32> %r, <16 x i8> %a, <16 x i8> %b)
// CHECK: ret <4 x i32> [[VAL]]
...
// CHECK: [[VAL:%.*]] = call <2 x i32> @llvm.arm.trezoaneon.usdot.v2i32.v8i8(<2 x i32> %r, <8 x i8> %a, <8 x i8> %b)
...
// CHECK: [[OP:%.*]] = call <2 x i32> @llvm.arm.trezoaneon.usdot.v2i32.v8i8(<2 x i32> %r, <8 x i8> %a, <8 x i8> [[TMP3]])
...
// CHECK: [[TMP3:%.*]] = bitcast <2 x i32> [[LANE]] to <8 x i8>
// CHECK: [[TMP4:%.*]] = bitcast <2 x i32> %r to <8 x i8>
// CHECK: [[OP:%.*]] = call <2 x i32> @llvm.arm.trezoaneon.usdot.v2i32.v8i8(<2 x i32> %r, <8 x i8> [[TMP3]], <8 x i8> %a)
// CHECK: ret <2 x i32> [[OP]]
...
// CHECK: [[OP:%.*]] = call <4 x i32> @llvm.arm.trezoaneon.usdot.v4i32.v16i8(<4 x i32> %r, <16 x i8> %a, <16 x i8> [[TMP4]])
...
// CHECK: [[OP:%.*]] = call <4 x i32> @llvm.arm.trezoaneon.usdot.v4i32.v16i8(<4 x i32> %r, <16 x i8> %3, <16 x i8> %a)
// CHECK: ret <4 x i32> [[OP]]
