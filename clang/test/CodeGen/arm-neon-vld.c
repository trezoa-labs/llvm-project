...
// CHECK: [[VLD1XN:%.*]] = call { <4 x [[HALF:half|i16]]>, <4 x [[HALF]]> } @llvm.{{aarch64.trezoaneon.ld1x2.v4f16.p0|arm.trezoaneon.vld1x2.v4i16.p0}}(ptr %a)
...
// CHECK: [[VLD1XN:%.*]] = call { <4 x [[HALF:half|i16]]>, <4 x [[HALF]]>, <4 x [[HALF]]> } @llvm.{{aarch64.trezoaneon.ld1x3.v4f16.p0|arm.trezoaneon.vld1x3.v4i16.p0}}(ptr %a)
...
// CHECK: [[VLD1XN:%.*]] = call { <4 x [[HALF:half|i16]]>, <4 x [[HALF]]>, <4 x [[HALF]]>, <4 x [[HALF]]> } @llvm.{{aarch64.trezoaneon.ld1x4.v4f16.p0|arm.trezoaneon.vld1x4.v4i16.p0}}(ptr %a)
...
// CHECK: [[VLD1XN:%.*]] = call { <2 x float>, <2 x float> } @llvm.{{aarch64.trezoaneon.ld1x2|arm.trezoaneon.vld1x2}}.v2f32.p0(ptr %a)
...
// CHECK: [[VLD1XN:%.*]] = call { <2 x float>, <2 x float>, <2 x float> } @llvm.{{aarch64.trezoaneon.ld1x3|arm.trezoaneon.vld1x3}}.v2f32.p0(ptr %a)
...
// CHECK: [[VLD1XN:%.*]] = call { <2 x float>, <2 x float>, <2 x float>, <2 x float> } @llvm.{{aarch64.trezoaneon.ld1x4|arm.trezoaneon.vld1x4}}.v2f32.p0(ptr %a)
...
// CHECK: [[VLD1XN:%.*]] = call { <4 x i16>, <4 x i16> } @llvm.{{aarch64.trezoaneon.ld1x2|arm.trezoaneon.vld1x2}}.v4i16.p0(ptr %a)
...
// CHECK: [[VLD1XN:%.*]] = call { <4 x i16>, <4 x i16>, <4 x i16> } @llvm.{{aarch64.trezoaneon.ld1x3|arm.trezoaneon.vld1x3}}.v4i16.p0(ptr %a)
...
// CHECK: [[VLD1XN:%.*]] = call { <4 x i16>, <4 x i16>, <4 x i16>, <4 x i16> } @llvm.{{aarch64.trezoaneon.ld1x4|arm.trezoaneon.vld1x4}}.v4i16.p0(ptr %a)
...
// CHECK: [[VLD1XN:%.*]] = call { <8 x i8>, <8 x i8> } @llvm.{{aarch64.trezoaneon.ld1x2|arm.trezoaneon.vld1x2}}.v8i8.p0(ptr %a)
...
// CHECK: [[VLD1XN:%.*]] = call { <8 x i8>, <8 x i8>, <8 x i8> } @llvm.{{aarch64.trezoaneon.ld1x3|arm.trezoaneon.vld1x3}}.v8i8.p0(ptr %a)
...
// CHECK: [[VLD1XN:%.*]] = call { <8 x i8>, <8 x i8>, <8 x i8>, <8 x i8> } @llvm.{{aarch64.trezoaneon.ld1x4|arm.trezoaneon.vld1x4}}.v8i8.p0(ptr %a)
...
// CHECK: [[VLD1XN:%.*]] = call { <2 x i32>, <2 x i32> } @llvm.{{aarch64.trezoaneon.ld1x2|arm.trezoaneon.vld1x2}}.v2i32.p0(ptr %a)
...
// CHECK: [[VLD1XN:%.*]] = call { <2 x i32>, <2 x i32>, <2 x i32> } @llvm.{{aarch64.trezoaneon.ld1x3|arm.trezoaneon.vld1x3}}.v2i32.p0(ptr %a)
...
// CHECK: [[VLD1XN:%.*]] = call { <2 x i32>, <2 x i32>, <2 x i32>, <2 x i32> } @llvm.{{aarch64.trezoaneon.ld1x4|arm.trezoaneon.vld1x4}}.v2i32.p0(ptr %a)
...
// CHECK: [[VLD1XN:%.*]] = call { <1 x i64>, <1 x i64> } @llvm.{{aarch64.trezoaneon.ld1x2|arm.trezoaneon.vld1x2}}.v1i64.p0(ptr %a)
...
// CHECK: [[VLD1XN:%.*]] = call { <1 x i64>, <1 x i64>, <1 x i64> } @llvm.{{aarch64.trezoaneon.ld1x3|arm.trezoaneon.vld1x3}}.v1i64.p0(ptr %a)
...
// CHECK: [[VLD1XN:%.*]] = call { <1 x i64>, <1 x i64>, <1 x i64>, <1 x i64> } @llvm.{{aarch64.trezoaneon.ld1x4|arm.trezoaneon.vld1x4}}.v1i64.p0(ptr %a)
...
// CHECK: [[VLD1XN:%.*]] = call { <8 x [[HALF:half|i16]]>, <8 x [[HALF]]> } @llvm.{{aarch64.trezoaneon.ld1x2.v8f16.p0|arm.trezoaneon.vld1x2.v8i16.p0}}(ptr %a)
...
// CHECK: [[VLD1XN:%.*]] = call { <8 x [[HALF:half|i16]]>, <8 x [[HALF]]>, <8 x [[HALF]]> } @llvm.{{aarch64.trezoaneon.ld1x3.v8f16.p0|arm.trezoaneon.vld1x3.v8i16.p0}}(ptr %a)
...
// CHECK: [[VLD1XN:%.*]] = call { <8 x [[HALF:half|i16]]>, <8 x [[HALF]]>, <8 x [[HALF]]>, <8 x [[HALF]]> } @llvm.{{aarch64.trezoaneon.ld1x4.v8f16.p0|arm.trezoaneon.vld1x4.v8i16.p0}}(ptr %a)
...
// CHECK: [[VLD1XN:%.*]] = call { <4 x float>, <4 x float> } @llvm.{{aarch64.trezoaneon.ld1x2|arm.trezoaneon.vld1x2}}.v4f32.p0(ptr %a)
...
// CHECK: [[VLD1XN:%.*]] = call { <4 x float>, <4 x float>, <4 x float> } @llvm.{{aarch64.trezoaneon.ld1x3|arm.trezoaneon.vld1x3}}.v4f32.p0(ptr %a)
...
// CHECK: [[VLD1XN:%.*]] = call { <4 x float>, <4 x float>, <4 x float>, <4 x float> } @llvm.{{aarch64.trezoaneon.ld1x4|arm.trezoaneon.vld1x4}}.v4f32.p0(ptr %a)
...
// CHECK: [[VLD1XN:%.*]] = call { <8 x i16>, <8 x i16> } @llvm.{{aarch64.trezoaneon.ld1x2|arm.trezoaneon.vld1x2}}.v8i16.p0(ptr %a)
...
// CHECK: [[VLD1XN:%.*]] = call { <8 x i16>, <8 x i16>, <8 x i16> } @llvm.{{aarch64.trezoaneon.ld1x3|arm.trezoaneon.vld1x3}}.v8i16.p0(ptr %a)
...
// CHECK: [[VLD1XN:%.*]] = call { <8 x i16>, <8 x i16>, <8 x i16>, <8 x i16> } @llvm.{{aarch64.trezoaneon.ld1x4|arm.trezoaneon.vld1x4}}.v8i16.p0(ptr %a)
...
// CHECK: [[VLD1XN:%.*]] = call { <16 x i8>, <16 x i8> } @llvm.{{aarch64.trezoaneon.ld1x2|arm.trezoaneon.vld1x2}}.v16i8.p0(ptr %a)
...
// CHECK: [[VLD1XN:%.*]] = call { <16 x i8>, <16 x i8>, <16 x i8> } @llvm.{{aarch64.trezoaneon.ld1x3|arm.trezoaneon.vld1x3}}.v16i8.p0(ptr %a)
...
// CHECK: [[VLD1XN:%.*]] = call { <16 x i8>, <16 x i8>, <16 x i8>, <16 x i8> } @llvm.{{aarch64.trezoaneon.ld1x4|arm.trezoaneon.vld1x4}}.v16i8.p0(ptr %a)
...
// CHECK: [[VLD1XN:%.*]] = call { <4 x i32>, <4 x i32> } @llvm.{{aarch64.trezoaneon.ld1x2|arm.trezoaneon.vld1x2}}.v4i32.p0(ptr %a)
...
// CHECK: [[VLD1XN:%.*]] = call { <4 x i32>, <4 x i32>, <4 x i32> } @llvm.{{aarch64.trezoaneon.ld1x3|arm.trezoaneon.vld1x3}}.v4i32.p0(ptr %a)
...
// CHECK: [[VLD1XN:%.*]] = call { <4 x i32>, <4 x i32>, <4 x i32>, <4 x i32> } @llvm.{{aarch64.trezoaneon.ld1x4|arm.trezoaneon.vld1x4}}.v4i32.p0(ptr %a)
...
// CHECK: [[VLD1XN:%.*]] = call { <2 x i64>, <2 x i64> } @llvm.{{aarch64.trezoaneon.ld1x2|arm.trezoaneon.vld1x2}}.v2i64.p0(ptr %a)
...
// CHECK: [[VLD1XN:%.*]] = call { <2 x i64>, <2 x i64>, <2 x i64> } @llvm.{{aarch64.trezoaneon.ld1x3|arm.trezoaneon.vld1x3}}.v2i64.p0(ptr %a)
...
// CHECK: [[VLD1XN:%.*]] = call { <2 x i64>, <2 x i64>, <2 x i64>, <2 x i64> } @llvm.{{aarch64.trezoaneon.ld1x4|arm.trezoaneon.vld1x4}}.v2i64.p0(ptr %a)
...
// CHECK: [[__RET:%.*]] = alloca %struct.float16x4x2_t, align 8
// CHECK-A64: [[VLD2:%.*]] = call { <4 x half>, <4 x half> } @llvm.aarch64.trezoaneon.ld2r.v4f16.p0(ptr %src)
// CHECK-A32: [[VLD2:%.*]] = call { <4 x i16>, <4 x i16> } @llvm.arm.trezoaneon.vld2dup.v4i16.p0(ptr %src, i32 2)
...
// CHECK: [[__RET:%.*]] = alloca %struct.float32x2x2_t, align 8
// CHECK-A64: [[VLD2:%.*]] = call { <2 x float>, <2 x float> } @llvm.aarch64.trezoaneon.ld2r.v2f32.p0(ptr %src)
// CHECK-A32: [[VLD2:%.*]] = call { <2 x float>, <2 x float> } @llvm.arm.trezoaneon.vld2dup.v2f32.p0(ptr %src, i32 4)
...
// CHECK: [[__RET:%.*]] = alloca %struct.poly16x4x2_t, align 8
// CHECK-A64: [[VLD2:%.*]] = call { <4 x i16>, <4 x i16> } @llvm.aarch64.trezoaneon.ld2r.v4i16.p0(ptr %src)
// CHECK-A32: [[VLD2:%.*]] = call { <4 x i16>, <4 x i16> } @llvm.arm.trezoaneon.vld2dup.v4i16.p0(ptr %src, i32 2)
...
// CHECK: [[__RET:%.*]] = alloca %struct.poly8x8x2_t, align 8
// CHECK-A64: [[VLD2:%.*]] = call { <8 x i8>, <8 x i8> } @llvm.aarch64.trezoaneon.ld2r.v8i8.p0(ptr %src)
// CHECK-A32: [[VLD2:%.*]] = call { <8 x i8>, <8 x i8> } @llvm.arm.trezoaneon.vld2dup.v8i8.p0(ptr %src, i32 1)
...
// CHECK: [[__RET:%.*]] = alloca %struct.int32x2x2_t, align 8
// CHECK-A64: [[VLD2:%.*]] = call { <2 x i32>, <2 x i32> } @llvm.aarch64.trezoaneon.ld2r.v2i32.p0(ptr %src)
// CHECK-A32: [[VLD2:%.*]] = call { <2 x i32>, <2 x i32> } @llvm.arm.trezoaneon.vld2dup.v2i32.p0(ptr %src, i32 4)
...
// CHECK: [[__RET:%.*]] = alloca %struct.int64x1x2_t, align 8
// CHECK-A64: [[VLD2:%.*]] = call { <1 x i64>, <1 x i64> } @llvm.aarch64.trezoaneon.ld2r.v1i64.p0(ptr %src)
// CHECK-A32: [[VLD2:%.*]] = call { <1 x i64>, <1 x i64> } @llvm.arm.trezoaneon.vld2dup.v1i64.p0(ptr %src, i32 8)
...
// CHECK: [[__RET:%.*]] = alloca %struct.float16x4x3_t, align 8
// CHECK-A64: [[VLD3:%.*]] = call { <4 x half>, <4 x half>, <4 x half> } @llvm.aarch64.trezoaneon.ld3r.v4f16.p0(ptr %src)
// CHECK-A32: [[VLD3:%.*]] = call { <4 x i16>, <4 x i16>, <4 x i16> } @llvm.arm.trezoaneon.vld3dup.v4i16.p0(ptr %src, i32 2)
...
// CHECK: [[__RET:%.*]] = alloca %struct.float32x2x3_t, align 8
// CHECK-A64: [[VLD3:%.*]] = call { <2 x float>, <2 x float>, <2 x float> } @llvm.aarch64.trezoaneon.ld3r.v2f32.p0(ptr %src)
// CHECK-A32: [[VLD3:%.*]] = call { <2 x float>, <2 x float>, <2 x float> } @llvm.arm.trezoaneon.vld3dup.v2f32.p0(ptr %src, i32 4)
...
// CHECK: [[__RET:%.*]] = alloca %struct.poly16x4x3_t, align 8
// CHECK-A64: [[VLD3:%.*]] = call { <4 x i16>, <4 x i16>, <4 x i16> } @llvm.aarch64.trezoaneon.ld3r.v4i16.p0(ptr %src)
// CHECK-A32: [[VLD3:%.*]] = call { <4 x i16>, <4 x i16>, <4 x i16> } @llvm.arm.trezoaneon.vld3dup.v4i16.p0(ptr %src, i32 2)
...
// CHECK: [[__RET:%.*]] = alloca %struct.poly8x8x3_t, align 8
// CHECK-A64: [[VLD3:%.*]] = call { <8 x i8>, <8 x i8>, <8 x i8> } @llvm.aarch64.trezoaneon.ld3r.v8i8.p0(ptr %src)
// CHECK-A32: [[VLD3:%.*]] = call { <8 x i8>, <8 x i8>, <8 x i8> } @llvm.arm.trezoaneon.vld3dup.v8i8.p0(ptr %src, i32 1)
...
// CHECK: [[__RET:%.*]] = alloca %struct.int32x2x3_t, align 8
// CHECK-A64: [[VLD3:%.*]] = call { <2 x i32>, <2 x i32>, <2 x i32> } @llvm.aarch64.trezoaneon.ld3r.v2i32.p0(ptr %src)
// CHECK-A32: [[VLD3:%.*]] = call { <2 x i32>, <2 x i32>, <2 x i32> } @llvm.arm.trezoaneon.vld3dup.v2i32.p0(ptr %src, i32 4)
...
// CHECK: [[__RET:%.*]] = alloca %struct.int64x1x3_t, align 8
// CHECK-A64: [[VLD3:%.*]] = call { <1 x i64>, <1 x i64>, <1 x i64> } @llvm.aarch64.trezoaneon.ld3r.v1i64.p0(ptr %src)
// CHECK-A32: [[VLD3:%.*]] = call { <1 x i64>, <1 x i64>, <1 x i64> } @llvm.arm.trezoaneon.vld3dup.v1i64.p0(ptr %src, i32 8)
...
// CHECK: [[__RET:%.*]] = alloca %struct.float16x4x4_t, align 8
// CHECK-A64: [[VLD4:%.*]] = call { <4 x half>, <4 x half>, <4 x half>, <4 x half> } @llvm.aarch64.trezoaneon.ld4r.v4f16.p0(ptr %src)
// CHECK-A32: [[VLD4:%.*]] = call { <4 x i16>, <4 x i16>, <4 x i16>, <4 x i16> } @llvm.arm.trezoaneon.vld4dup.v4i16.p0(ptr %src, i32 2)
...
// CHECK: [[__RET:%.*]] = alloca %struct.float32x2x4_t, align 8
// CHECK-A64: [[VLD4:%.*]] = call { <2 x float>, <2 x float>, <2 x float>, <2 x float> } @llvm.aarch64.trezoaneon.ld4r.v2f32.p0(ptr %src)
// CHECK-A32: [[VLD4:%.*]] = call { <2 x float>, <2 x float>, <2 x float>, <2 x float> } @llvm.arm.trezoaneon.vld4dup.v2f32.p0(ptr %src, i32 4)
...
// CHECK: [[__RET:%.*]] = alloca %struct.poly16x4x4_t, align 8
// CHECK-A64: [[VLD4:%.*]] = call { <4 x i16>, <4 x i16>, <4 x i16>, <4 x i16> } @llvm.aarch64.trezoaneon.ld4r.v4i16.p0(ptr %src)
// CHECK-A32: [[VLD4:%.*]] = call { <4 x i16>, <4 x i16>, <4 x i16>, <4 x i16> } @llvm.arm.trezoaneon.vld4dup.v4i16.p0(ptr %src, i32 2)
...
// CHECK: [[__RET:%.*]] = alloca %struct.poly8x8x4_t, align 8
// CHECK-A64: [[VLD4:%.*]] = call { <8 x i8>, <8 x i8>, <8 x i8>, <8 x i8> } @llvm.aarch64.trezoaneon.ld4r.v8i8.p0(ptr %src)
// CHECK-A32: [[VLD4:%.*]] = call { <8 x i8>, <8 x i8>, <8 x i8>, <8 x i8> } @llvm.arm.trezoaneon.vld4dup.v8i8.p0(ptr %src, i32 1)
...
// CHECK: [[__RET:%.*]] = alloca %struct.int32x2x4_t, align 8
// CHECK-A64: [[VLD4:%.*]] = call { <2 x i32>, <2 x i32>, <2 x i32>, <2 x i32> } @llvm.aarch64.trezoaneon.ld4r.v2i32.p0(ptr %src)
// CHECK-A32: [[VLD4:%.*]] = call { <2 x i32>, <2 x i32>, <2 x i32>, <2 x i32> } @llvm.arm.trezoaneon.vld4dup.v2i32.p0(ptr %src, i32 4)
...
// CHECK: [[__RET:%.*]] = alloca %struct.int64x1x4_t, align 8
// CHECK-A64: [[VLD4:%.*]] = call { <1 x i64>, <1 x i64>, <1 x i64>, <1 x i64> } @llvm.aarch64.trezoaneon.ld4r.v1i64.p0(ptr %src)
// CHECK-A32: [[VLD4:%.*]] = call { <1 x i64>, <1 x i64>, <1 x i64>, <1 x i64> } @llvm.arm.trezoaneon.vld4dup.v1i64.p0(ptr %src, i32 8)
...
// CHECK: [[__RET:%.*]] = alloca %struct.float16x8x2_t, align {{16|8}}
// CHECK-A64: [[VLD2:%.*]] = call { <8 x half>, <8 x half> } @llvm.aarch64.trezoaneon.ld2r.v8f16.p0(ptr %src)
// CHECK-A32: [[VLD2:%.*]] = call { <8 x i16>, <8 x i16> } @llvm.arm.trezoaneon.vld2dup.v8i16.p0(ptr %src, i32 2)
...
// CHECK: [[__RET:%.*]] = alloca %struct.float32x4x2_t, align {{16|8}}
// CHECK-A64: [[VLD2:%.*]] = call { <4 x float>, <4 x float> } @llvm.aarch64.trezoaneon.ld2r.v4f32.p0(ptr %src)
// CHECK-A32: [[VLD2:%.*]] = call { <4 x float>, <4 x float> } @llvm.arm.trezoaneon.vld2dup.v4f32.p0(ptr %src, i32 4)
...
// CHECK: [[__RET:%.*]] = alloca %struct.poly16x8x2_t, align {{16|8}}
// CHECK-A64: [[VLD2:%.*]] = call { <8 x i16>, <8 x i16> } @llvm.aarch64.trezoaneon.ld2r.v8i16.p0(ptr %src)
// CHECK-A32: [[VLD2:%.*]] = call { <8 x i16>, <8 x i16> } @llvm.arm.trezoaneon.vld2dup.v8i16.p0(ptr %src, i32 2)
...
// CHECK: [[__RET:%.*]] = alloca %struct.poly8x16x2_t, align {{16|8}}
// CHECK-A64: [[VLD2:%.*]] = call { <16 x i8>, <16 x i8> } @llvm.aarch64.trezoaneon.ld2r.v16i8.p0(ptr %src)
// CHECK-A32: [[VLD2:%.*]] = call { <16 x i8>, <16 x i8> } @llvm.arm.trezoaneon.vld2dup.v16i8.p0(ptr %src, i32 1)
...
// CHECK: [[__RET:%.*]] = alloca %struct.int32x4x2_t, align {{16|8}}
// CHECK-A64: [[VLD2:%.*]] = call { <4 x i32>, <4 x i32> } @llvm.aarch64.trezoaneon.ld2r.v4i32.p0(ptr %src)
// CHECK-A32: [[VLD2:%.*]] = call { <4 x i32>, <4 x i32> } @llvm.arm.trezoaneon.vld2dup.v4i32.p0(ptr %src, i32 4)
...
// CHECK: [[__RET:%.*]] = alloca %struct.float16x8x3_t, align {{16|8}}
// CHECK-A64: [[VLD3:%.*]] = call { <8 x half>, <8 x half>, <8 x half> } @llvm.aarch64.trezoaneon.ld3r.v8f16.p0(ptr %src)
// CHECK-A32: [[VLD3:%.*]] = call { <8 x i16>, <8 x i16>, <8 x i16> } @llvm.arm.trezoaneon.vld3dup.v8i16.p0(ptr %src, i32 2)
...
// CHECK: [[__RET:%.*]] = alloca %struct.float32x4x3_t, align {{16|8}}
// CHECK-A64: [[VLD3:%.*]] = call { <4 x float>, <4 x float>, <4 x float> } @llvm.aarch64.trezoaneon.ld3r.v4f32.p0(ptr %src)
// CHECK-A32: [[VLD3:%.*]] = call { <4 x float>, <4 x float>, <4 x float> } @llvm.arm.trezoaneon.vld3dup.v4f32.p0(ptr %src, i32 4)
...
// CHECK: [[__RET:%.*]] = alloca %struct.poly16x8x3_t, align {{16|8}}
// CHECK-A64: [[VLD3:%.*]] = call { <8 x i16>, <8 x i16>, <8 x i16> } @llvm.aarch64.trezoaneon.ld3r.v8i16.p0(ptr %src)
// CHECK-A32: [[VLD3:%.*]] = call { <8 x i16>, <8 x i16>, <8 x i16> } @llvm.arm.trezoaneon.vld3dup.v8i16.p0(ptr %src, i32 2)
...
// CHECK: [[__RET:%.*]] = alloca %struct.poly8x16x3_t, align {{16|8}}
// CHECK-A64: [[VLD3:%.*]] = call { <16 x i8>, <16 x i8>, <16 x i8> } @llvm.aarch64.trezoaneon.ld3r.v16i8.p0(ptr %src)
// CHECK-A32: [[VLD3:%.*]] = call { <16 x i8>, <16 x i8>, <16 x i8> } @llvm.arm.trezoaneon.vld3dup.v16i8.p0(ptr %src, i32 1)
...
// CHECK: [[__RET:%.*]] = alloca %struct.int32x4x3_t, align {{16|8}}
// CHECK-A64: [[VLD3:%.*]] = call { <4 x i32>, <4 x i32>, <4 x i32> } @llvm.aarch64.trezoaneon.ld3r.v4i32.p0(ptr %src)
// CHECK-A32: [[VLD3:%.*]] = call { <4 x i32>, <4 x i32>, <4 x i32> } @llvm.arm.trezoaneon.vld3dup.v4i32.p0(ptr %src, i32 4)
...
// CHECK: [[__RET:%.*]] = alloca %struct.float16x8x4_t, align {{16|8}}
// CHECK-A64: [[VLD4:%.*]] = call { <8 x half>, <8 x half>, <8 x half>, <8 x half> } @llvm.aarch64.trezoaneon.ld4r.v8f16.p0(ptr %src)
// CHECK-A32: [[VLD4:%.*]] = call { <8 x i16>, <8 x i16>, <8 x i16>, <8 x i16> } @llvm.arm.trezoaneon.vld4dup.v8i16.p0(ptr %src, i32 2)
...
// CHECK: [[__RET:%.*]] = alloca %struct.float32x4x4_t, align {{16|8}}
// CHECK-A64: [[VLD4:%.*]] = call { <4 x float>, <4 x float>, <4 x float>, <4 x float> } @llvm.aarch64.trezoaneon.ld4r.v4f32.p0(ptr %src)
// CHECK-A32: [[VLD4:%.*]] = call { <4 x float>, <4 x float>, <4 x float>, <4 x float> } @llvm.arm.trezoaneon.vld4dup.v4f32.p0(ptr %src, i32 4)
...
// CHECK: [[__RET:%.*]] = alloca %struct.poly16x8x4_t, align {{16|8}}
// CHECK-A64: [[VLD4:%.*]] = call { <8 x i16>, <8 x i16>, <8 x i16>, <8 x i16> } @llvm.aarch64.trezoaneon.ld4r.v8i16.p0(ptr %src)
// CHECK-A32: [[VLD4:%.*]] = call { <8 x i16>, <8 x i16>, <8 x i16>, <8 x i16> } @llvm.arm.trezoaneon.vld4dup.v8i16.p0(ptr %src, i32 2)
...
// CHECK: [[__RET:%.*]] = alloca %struct.poly8x16x4_t, align {{16|8}}
// CHECK-A64: [[VLD4:%.*]] = call { <16 x i8>, <16 x i8>, <16 x i8>, <16 x i8> } @llvm.aarch64.trezoaneon.ld4r.v16i8.p0(ptr %src)
// CHECK-A32: [[VLD4:%.*]] = call { <16 x i8>, <16 x i8>, <16 x i8>, <16 x i8> } @llvm.arm.trezoaneon.vld4dup.v16i8.p0(ptr %src, i32 1)
...
// CHECK: [[__RET:%.*]] = alloca %struct.int32x4x4_t, align {{16|8}}
// CHECK-A64: [[VLD4:%.*]] = call { <4 x i32>, <4 x i32>, <4 x i32>, <4 x i32> } @llvm.aarch64.trezoaneon.ld4r.v4i32.p0(ptr %src)
// CHECK-A32: [[VLD4:%.*]] = call { <4 x i32>, <4 x i32>, <4 x i32>, <4 x i32> } @llvm.arm.trezoaneon.vld4dup.v4i32.p0(ptr %src, i32 4)
