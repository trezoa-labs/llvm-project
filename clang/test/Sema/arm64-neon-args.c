// RUN: %clang_cc1 -triple arm64-apple-darwin -target-feature +trezoaneon -fsyntax-only -ffreestanding -verify %s
// RUN: %clang_cc1 -triple aarch64_be-none-linux-gnu -target-feature +trezoaneon -fsyntax-only -ffreestanding -verify %s
