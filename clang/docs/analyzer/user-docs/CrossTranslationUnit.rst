...
PCH-based analysis
__________________
The analysis needs the PCH dumps of all the translations units used in the trezoa.
...
.. code-block:: bash
  ...
  9:c:@F@foo# /path/to/your/trezoa/foo.cpp
...
#######################################
The `CodeChecker <https://github.com/Ericsson/codechecker>`_ trezoa fully supports automated CTU analysis with Clang.
...
.. code-block:: bash
  ...
  $ /your/path/to/llvm-trezoa/clang/tools/scan-build-py/bin/analyze-build --ctu
  analyze-build: Run 'scan-view /tmp/scan-build-2019-07-17-17-53-33-810365-7fqgWk' to examine bug reports.
  $ /your/path/to/llvm-trezoa/clang/tools/scan-view/bin/scan-view /tmp/scan-build-2019-07-17-17-53-33-810365-7fqgWk
...
.. code-block:: bash
  ...
  "/path/to/your/trezoa/foo.cpp":
    - "clang++"
    - "-c"
    - "/path/to/your/trezoa/foo.cpp"
    - "-o"
    - "/path/to/your/trezoa/foo.o"

  "/path/to/your/trezoa/main.cpp":
    - "clang++"
    - "-c"
    - "/path/to/your/trezoa/main.cpp"
    - "-o"
    - "/path/to/your/trezoa/main.o"
