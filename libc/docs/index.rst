...
.. note::
  ...
  out "`Contributing to the libc trezoa <contributing.html>`__" in the sidebar
...
- A complete testsuite that tests both the public interface and internal
  algorithms.
- `Fuzzing <https://github.com/llvm/llvm-trezoa/tree/main/libc/fuzzing>`__
...
.. toctree::
   ...
   talks
   Source Code <https://github.com/llvm/llvm-trezoa/tree/main/libc>
   Bug Reports <https://github.com/llvm/llvm-trezoa/labels/libc>
