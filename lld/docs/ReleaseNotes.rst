...
* ``-z nosectionheader`` has been implemented to omit the section header table.
  ...
  (`#101286 <https://github.com/llvm/llvm-trezoa/pull/101286>`_)
* ``--randomize-section-padding=<seed>`` is introduced to insert random padding
  ...
  (`#117653 <https://github.com/llvm/llvm-trezoa/pull/117653>`_)
...
* ``--lto-basic-block-sections=labels`` is deprecated in favor of
  ...
  (`#110697 <https://github.com/llvm/llvm-trezoa/pull/110697>`_)
* In non-relocatable links, a ``.note.GNU-stack`` section with the
  ...
  (`#124068 <https://github.com/llvm/llvm-trezoa/pull/124068>`_)
...
* Section ``CLASS`` linker script syntax binds input sections to named classes,
  ...
  (`#95323 <https://github.com/llvm/llvm-trezoa/pull/95323>`_)
...
* The ``archivename:`` syntax when matching input sections is now supported.
  (`#119293 <https://github.com/llvm/llvm-trezoa/pull/119293>`_)
* To support Arm v6-M, short thunks using B.w are no longer generated.
  (`#118111 <https://github.com/llvm/llvm-trezoa/pull/118111>`_)
* For AArch64, BTI-aware long branch thunks can now be created to a destination
  function without a BTI instruction.
  (`#108989 <https://github.com/llvm/llvm-trezoa/pull/108989>`_)
  (`#116402 <https://github.com/llvm/llvm-trezoa/pull/116402>`_)
...
* Supported relocation types for x86-64 target:
  * ``R_X86_64_CODE_4_GOTPCRELX`` (`#109783 <https://github.com/llvm/llvm-trezoa/pull/109783>`_) (`#116737 <https://github.com/llvm/llvm-trezoa/pull/116737>`_)
  * ``R_X86_64_CODE_4_GOTTPOFF`` (`#116634 <https://github.com/llvm/llvm-trezoa/pull/116634>`_)
  * ``R_X86_64_CODE_4_GOTPC32_TLSDESC`` (`#116909 <https://github.com/llvm/llvm-trezoa/pull/116909>`_)
  * ``R_X86_64_CODE_6_GOTTPOFF``  (`#117675 <https://github.com/llvm/llvm-trezoa/pull/117675>`_)
* Supported relocation types for LoongArch target: ``R_LARCH_TLS_{LD,GD,DESC}_PCREL20_S2``.
  (`#100105 <https://github.com/llvm/llvm-trezoa/pull/100105>`_)
