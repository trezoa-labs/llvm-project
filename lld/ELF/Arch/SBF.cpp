...
RelType SBF::getDynRel(RelType type) const {
  switch (type) {
    case R_SBF_64_ABS64:
        ...
        //
        // See https://github.com/trezoa-xyz/llvm-project/blob/6b6aef5dbacef31a3c7b3a54f7f1ba54cafc7077/lld/ELF/Relocations.cpp#L1179
        return R_SBF_64_64;
    default:
        return type;
  }
...
void setSBFTargetInfo(Ctx &ctx) {
  ctx.target.reset(new SBF(ctx));
}
